                    ...
                    <div class="filter-sidebar">
                        ...
                        <form action="${pageContext.request.contextPath}/client/search" method="get">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="brand" class="form-select">
                                    ...
                                    <c:forEach var="brandItem" items="${brands}">
                                        <option value="${fn:escapeXml(brandItem)}" ${param.brand == brandItem ? 'selected' : ''}>
                                            ${fn:escapeXml(brandItem)}
                                        </option>
                                    </c:forEach>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        <input type="number" name="minPrice" value="${fn:escapeXml(param.minPrice)}" 
                                               class="form-control" placeholder="Min" min="0">
                                    </div>
                                    <div class="col-6">
                                        <input type="number" name="maxPrice" value="${fn:escapeXml(param.maxPrice)}" 
                                ...
                                <div class="mt-2">
                                    ...
                                    <c:if test="${not empty param.category}">
                                        <span class="badge bg-info ms-2">
                                            Category: 
                                            <c:forEach var="cat" items="${listCC}">
                                                <c:if test="${cat.id == param.category}">${fn:escapeXml(cat.name)}</c:if>
                                            </c:forEach>
                                        </span>
                                    </c:if>
                                    <c:if test="${not empty param.brand}">
                                        <span class="badge bg-info ms-2">Brand: ${fn:escapeXml(param.brand)}</span>
                                    </c:if>
